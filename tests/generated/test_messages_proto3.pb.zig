...
pub const TestAllTypesProto3 = struct {
    ...
    optional_nested_message: ?*const TestAllTypesProto3.NestedMessage = null,
    ...
    optional_bool_wrapper: ?*const google_protobuf_wrappers_proto.BoolValue = null,
    optional_int32_wrapper: ?*const google_protobuf_wrappers_proto.Int32Value = null,
    optional_int64_wrapper: ?*const google_protobuf_wrappers_proto.Int64Value = null,
    optional_uint32_wrapper: ?*const google_protobuf_wrappers_proto.UInt32Value = null,
    optional_uint64_wrapper: ?*const google_protobuf_wrappers_proto.UInt64Value = null,
    optional_float_wrapper: ?*const google_protobuf_wrappers_proto.FloatValue = null,
    optional_double_wrapper: ?*const google_protobuf_wrappers_proto.DoubleValue = null,
    optional_string_wrapper: ?*const google_protobuf_wrappers_proto.StringValue = null,
    optional_bytes_wrapper: ?*const google_protobuf_wrappers_proto.BytesValue = null,
    ...
    optional_duration: ?*const google_protobuf_duration_proto.Duration = null,
    optional_timestamp: ?*const google_protobuf_timestamp_proto.Timestamp = null,
    optional_field_mask: ?*const google_protobuf_field_mask_proto.FieldMask = null,
    optional_struct: ?*const google_protobuf_struct_proto.Struct = null,
    optional_any: ?*const google_protobuf_any_proto.Any = null,
    ...
    oneof_field: ?union(enum) {
        oneof_uint32: u32,
        oneof_nested_message: *const TestAllTypesProto3.NestedMessage,
    ...
    pub const _desc_table = .{
        ...
        .optional_bool_wrapper = fd(201, .{ .AllocMessage = {} }),
        .optional_int32_wrapper = fd(202, .{ .AllocMessage = {} }),
        .optional_int64_wrapper = fd(203, .{ .AllocMessage = {} }),
        .optional_uint32_wrapper = fd(204, .{ .AllocMessage = {} }),
        .optional_uint64_wrapper = fd(205, .{ .AllocMessage = {} }),
        .optional_float_wrapper = fd(206, .{ .AllocMessage = {} }),
        .optional_double_wrapper = fd(207, .{ .AllocMessage = {} }),
        .optional_string_wrapper = fd(208, .{ .AllocMessage = {} }),
        .optional_bytes_wrapper = fd(209, .{ .AllocMessage = {} }),
        ...
        .optional_duration = fd(301, .{ .AllocMessage = {} }),
        .optional_timestamp = fd(302, .{ .AllocMessage = {} }),
        .optional_field_mask = fd(303, .{ .AllocMessage = {} }),
        .optional_struct = fd(304, .{ .AllocMessage = {} }),
        .optional_any = fd(305, .{ .AllocMessage = {} }),
    ...
    pub const MapStringNestedMessageEntry = struct {
        key: ManagedString = .Empty,
        value: ?*const TestAllTypesProto3.NestedMessage = null,
    ...
    pub const MapStringForeignMessageEntry = struct {
        key: ManagedString = .Empty,
        value: ?*const ForeignMessage = null,
