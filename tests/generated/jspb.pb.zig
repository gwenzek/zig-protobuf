...
const google_protobuf_descriptor_proto = @import("google/protobuf/descriptor.pb.zig");
...
pub const TestMessageWithOneof = struct {
    ...
    pub const _desc_table = .{
        ...
        .partial_oneof = fd(null, .{ .OneOf = @FieldType(@This(), "partial_oneof") }),
        .recursive_oneof = fd(null, .{ .OneOf = @FieldType(@This(), "recursive_oneof") }),
        .default_oneof_a = fd(null, .{ .OneOf = @FieldType(@This(), "default_oneof_a") }),
        .default_oneof_b = fd(null, .{ .OneOf = @FieldType(@This(), "default_oneof_b") }),
    };
